package com.pierbezuhoff.define.ui.colorpicker
...
fun ClassicColorPicker(
    ...
    ClassicColorPicker(
        modifier = modifier,
        color = HsvColor.Companion.from(color),
...
fun ClassicColorPicker(
    modifier: Modifier = Modifier,
    color: HsvColor = HsvColor.Companion.from(Color.Red),
    showAlphaBar: Boolean = true,
    onColorChanged: (HsvColor) -> Unit
) {
    val colorPickerValueState = rememberSaveable(stateSaver = HsvColor.Companion.Saver) {
            ...
            if (showAlphaBar) {
                ...
                AlphaBar(
                    ...
                    onAlphaChanged = { alpha ->
                        colorPickerValueState.value =
                            colorPickerValueState.value.copy(alpha = alpha)
                        updatedOnColorChanged(colorPickerValueState.value)
                    }
                )
            }
